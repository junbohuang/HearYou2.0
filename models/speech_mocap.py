...
from keras.layers import BatchNormalization, Dense, Embedding, LSTM
...
def load():
    ...
    speech_layer = LSTM(256, return_sequences=True)(speech_layer)
    speech_layer = Dropout(0.2)(speech_layer)
    speech_layer = LSTM(256, return_sequences=False)(speech_layer)
    speech_layer = Dropout(0.2)(speech_layer)
